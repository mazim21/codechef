...
int leftmst,rightmst,topmst,botmst;
    ...
    /*if(n==2)
    {
     ...
     if(xc_lef == xc_rig)//( xc_bot == xc_top && xc_bot == xc_lef && xc_bot == xc_rig)
    {
        cout << 1<<"\n"<<topmst<<" SE"<<endl;
        //goto xx;
    }
    else if (yc_top == yc_bot)//( yc_lef == yc_rig && yc_lef== yc_bot && yc_lef==yc_top)
    {
        cout << 1<<"\n"<<leftmst<<" NE"<<endl;
    }

    else if( xc_top == xc_rig)//  topmst == rightmst)
    {
        cout << 1<<"\n"<<topmst <<" SW"<<endl;
        //goto xx;
    }
    ...
    else if( yc_lef == yc_top){
            cout <<1<<"\n"<<leftmst<<" SE"<<endl;

    }
    else if (yc_lef == yc_bot)
    {
        cout<<1<<"\n"<<leftmst<<" NE"<<endl;
    }
    else if( yc_rig == yc_top){
            cout <<1<<"\n"<<rightmst<<" SW"<<endl;

    }
    else if (yc_rig == yc_bot)
    {
        cout<<1<<"\n"<<rightmst<<" NW"<<endl;
    }
    else
         ...
         /*if (xc_top == xc_bot )
    {
        if(xc_lef == xc_top)
            cout <<1<<"\n"<<topmst<<" SE"<<endl;
        else if(xc_top == xc_rig)
            cout <<1<<"\n"<<topmst<<" SW"<<endl;
    }*/
    /*else if( yc_lef == yc_rig)
    {
        if( yc_top == yc_lef)
            cout <<1<<"\n"<<leftmst<<" SE"<<endl;
        else if( yc_bot == yc_lef)
            cout <<1<<"\n"<<leftmst<<" NE"<<endl;
    }*/
        ...
        {
            cout << 2<<"\n";
            cout << leftmst<<" SE"<<endl;
            cout << rightmst<<" NW"<<endl;
        }
        else
        {
             cout << 2<<"\n";
             cout << leftmst<<" NE"<<endl;
            cout << rightmst<<" SW"<<endl;
